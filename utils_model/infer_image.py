...
import os
import sys
sys.path.append(r'/disks/disk1/Workspace/mycode/algotrain/BasicSR-master')
...
if __name__ == '__main__':
    ...
    srcroot=[
        # r'/home/tao/mynas/Dataset/hairforsr/femalehd_crop2048_eyescrop_out'
        r'/home/tao/mynas/Dataset/hairforsr/nightface_crop2048_eyescrop'
    ][0]
    ...
    checkpath=[
        ...
        r'/disks/disk1/Workspace/mycode/exproot/eye_sr_debug/experiments/train_RealESRGANx2plus_400k_B12G4/models/net_g_36000.pth'
    ][0]
    ...
    for i,im in enumerate(ims):
        ...
        imgori=cv2.resize(imgori,(512,512))
        ...
        imgori=cv2.resize(imgori,None,fx=2,fy=2)
